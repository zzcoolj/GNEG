...
# grid_searcher = nsg.NegativeSamplesGenerator(ns_folder='output/intermediate data/negative_samples_partial_stochastic/',
...
gs.grid_search_bis(ns_folder='output/intermediate data/negative_samples_partial_stochastic/')
