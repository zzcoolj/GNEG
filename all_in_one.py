...
# start_time = time.time()
#
# grid_searcher = nsg.NegativeSamplesGenerator(ns_folder=whole_folder + 'ns_rw_noSelfLoops/',
...
# grid_searcher.many_to_many(encoded_edges_count_file_folder=whole_folder+'graph/', directed=False, t_max=4,
#                            process_num=9, partial=False, remove_self_loops=True)
#
# print('time in seconds:', common.count_time(start_time))
...
gs.one_search(matrix_path='output/intermediate data/ns_rw_noSelfLoops/encoded_edges_count_window_size_7_undirected_2_step_rw_matrix.npy',
...
gs.one_search(matrix_path='output/intermediate data/ns_rw_noSelfLoops/encoded_edges_count_window_size_5_undirected_4_step_rw_matrix.npy',
